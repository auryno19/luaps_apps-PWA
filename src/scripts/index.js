...
import FavoriteRestaurant from '../scripts/data/favorite.js';
import registerSw from './utils/register-sw';
import LikeButtonInitiator from './utils/like-button-initiator.js';
import API_ENDPOINT from './global/api_endpoint';
import { detail, list } from '../scripts/template/template-creator.js';
...
const getDetailResto = (idResto) => {
  ...
  const renderDetail = (restaurant) => {
    ...
    let category = document.querySelector('#detailCategorySlice').innerText;
